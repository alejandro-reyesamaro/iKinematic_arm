...
-IK_ParticleFiltering_NET.dll
   -contains the generated component using MWArray API. 
-IK_ParticleFiltering_NETNative.dll
...
IK_ParticleFiltering_NET_overview.html - HTML overview documentation file for the 
...
IK_ParticleFiltering_NET.xml - This file contains the code comments for the 
                                         IK_ParticleFiltering_NET component classes and 
                                         ...
                                         documentation for the IK_ParticleFiltering_NET 
                                         component.
