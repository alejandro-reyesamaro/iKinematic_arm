...
* Date: Fri Dec 24 01:57:11 2010
* Arguments: "-B" "macro_default" "-W" "dotnet:IK_PF_NET,IK_PF_NETclass,0.0,private" "-d"
* "C:\Documents and Settings\Administrador\Escritorio\My
* Work\MATH\ParticleFiltering\IK_ParticleFiltering\IK_PF_NET\src" "-T" "link:lib" "-v"
* "-C" "class{IK_PF_NETclass:C:\Documents and Settings\Administrador\Escritorio\My
...
namespace IK_PF_NET
{
  ...
  /// @Version 0.0
  /// </remarks>
  public class IK_PF_NETclass : IDisposable
    {
      #region Constructors
          ...
          if (MWArray.MCRAppInitialized)
            {
              ...
              mcr= new MWMCR(MCRComponentState.MCC_IK_PF_NET_name_data,
                             MCRComponentState.MCC_IK_PF_NET_root_data,
                             MCRComponentState.MCC_IK_PF_NET_public_data,
                             MCRComponentState.MCC_IK_PF_NET_session_data,
                             MCRComponentState.MCC_IK_PF_NET_matlabpath_data,
                             MCRComponentState.MCC_IK_PF_NET_classpath_data,
                             MCRComponentState.MCC_IK_PF_NET_libpath_data,
                             MCRComponentState.MCC_IK_PF_NET_mcr_application_options,
                             MCRComponentState.MCC_IK_PF_NET_mcr_runtime_options,
                             MCRComponentState.MCC_IK_PF_NET_mcr_pref_dir,
                             MCRComponentState.MCC_IK_PF_NET_set_warning_state,
                             ctfFilePath, true);
            }
          else
            {
      ...
      public MWArray weightFunction()
        {
          return mcr.EvaluateFunction("weightFunction");
        }
      ...
      public MWArray[] weightFunction(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "weightFunction");
        }
      ...
      ///
      public void weightFunction(int numArgsOut, ref MWArray[] argsOut,
                           MWArray[] argsIn)
        {
      ...
      public MWArray angulo()
        {
          return mcr.EvaluateFunction("angulo");
        }
      ...
      public MWArray[] angulo(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "angulo");
        }
      ...
      public MWArray createChain()
        {
          return mcr.EvaluateFunction("createChain");
        }
      ...
      public MWArray[] createChain(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "createChain");
        }
      ...
      public MWArray createParticle()
        {
          return mcr.EvaluateFunction("createParticle");
        }
      ...
      public MWArray[] createParticle(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "createParticle");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void createParticle(int numArgsOut, ref MWArray[] argsOut,
                           MWArray[] argsIn)
        {
      ...
      public MWArray chain2CCDquaternions()
        {
          return mcr.EvaluateFunction("chain2CCDquaternions");
        }
      ...
      public MWArray[] chain2CCDquaternions(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "chain2CCDquaternions");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void chain2CCDquaternions(int numArgsOut, ref MWArray[] argsOut,
                                 MWArray[] argsIn)
        {
      ...
      public MWArray chain2image()
        {
          return mcr.EvaluateFunction("chain2image");
        }
      ...
      public MWArray[] chain2image(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "chain2image");
        }
      ...
      ///
      public MWArray[] chain2image(int numArgsOut, MWArray chain,
                                   MWArray penSize, MWArray image_in1)
        {
          return mcr.EvaluateFunction(numArgsOut, "chain2image",
                                      chain, penSize, image_in1);
        }
      ...
      public MWArray chain2positions()
        {
          return mcr.EvaluateFunction("chain2positions");
        }
      ...
      public MWArray[] chain2positions(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "chain2positions");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void chain2positions(int numArgsOut, ref MWArray[] argsOut,
                            MWArray[] argsIn)
        {
      ...
      public MWArray chainCCDQuTemSamplig()
        {
          return mcr.EvaluateFunction("chainCCDQuTemSamplig");
        }
      ...
      public MWArray[] chainCCDQuTemSamplig(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "chainCCDQuTemSamplig");
        }
      ...
      ///
      public MWArray[] chainCCDQuTemSamplig(int numArgsOut,
                                            MWArray goal, MWArray g)
        {
          return mcr.EvaluateFunction(numArgsOut,
                                      "chainCCDQuTemSamplig", goal, g);
        }
      ...
      ///
      public MWArray[] chainCCDQuTemSamplig(int numArgsOut, MWArray goal,
                                            MWArray g, MWArray chain, MWArray f)
        {
          return mcr.EvaluateFunction(numArgsOut, "chainCCDQuTemSamplig",
                                      goal, g, chain, f);
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void chainCCDQuTemSamplig(int numArgsOut, ref MWArray[] argsOut,
                                 MWArray[] argsIn)
        {
      ...
      public MWArray chainEndEffectorPosition()
        {
          return mcr.EvaluateFunction("chainEndEffectorPosition");
        }
      ...
      public MWArray[] chainEndEffectorPosition(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "chainEndEffectorPosition");
        }
      ...
      public MWArray[] chainEndEffectorPosition(int numArgsOut, MWArray chain)
        {
          return mcr.EvaluateFunction(numArgsOut,
                                      "chainEndEffectorPosition", chain);
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void chainEndEffectorPosition(int numArgsOut, ref MWArray[] argsOut,
                                     MWArray[] argsIn)
        {
      ...
      public MWArray chainQuaternionUniformSampling()
        {
          return mcr.EvaluateFunction("chainQuaternionUniformSampling");
        }
      ...
      public MWArray[] chainQuaternionUniformSampling(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut,
                                      "chainQuaternionUniformSampling");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void chainQuaternionUniformSampling(int numArgsOut,
                                           ref MWArray[] argsOut,
                                           MWArray[] argsIn)
        {
          mcr.EvaluateFunction("chainQuaternionUniformSampling", numArgsOut, ref argsOut, argsIn);
        }
      ...
      public MWArray chainQuTEMSampling()
        {
          return mcr.EvaluateFunction("chainQuTEMSampling");
        }
      ...
      public MWArray[] chainQuTEMSampling(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "chainQuTEMSampling");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void chainQuTEMSampling(int numArgsOut, ref MWArray[] argsOut,
                               MWArray[] argsIn)
        {
      ...
      public MWArray dentro()
        {
          return mcr.EvaluateFunction("dentro");
        }
      ...
      public MWArray[] dentro(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "dentro");
        }
      ...
      public MWArray euclidianDistance()
        {
          return mcr.EvaluateFunction("euclidianDistance");
        }
      ...
      public MWArray[] euclidianDistance(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "euclidianDistance");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void euclidianDistance(int numArgsOut, ref MWArray[] argsOut,
                              MWArray[] argsIn)
        {
      ...
      public MWArray evalua_recta()
        {
          return mcr.EvaluateFunction("evalua_recta");
        }
      ...
      public MWArray[] evalua_recta(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "evalua_recta");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void evalua_recta(int numArgsOut, ref MWArray[] argsOut,
                         MWArray[] argsIn)
        {
      ...
      public MWArray imageDistance()
        {
          return mcr.EvaluateFunction("imageDistance");
        }
      ...
      public MWArray[] imageDistance(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "imageDistance");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void imageDistance(int numArgsOut, ref MWArray[] argsOut,
                          MWArray[] argsIn)
        {
      ...
      public MWArray mas()
        {
          return mcr.EvaluateFunction("mas");
        }
      ...
      public MWArray[] mas(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "mas");
        }
      ...
      public MWArray obstaculo_crecido()
        {
          return mcr.EvaluateFunction("obstaculo_crecido");
        }
      ...
      public MWArray[] obstaculo_crecido(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "obstaculo_crecido");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void obstaculo_crecido(int numArgsOut, ref MWArray[] argsOut,
                              MWArray[] argsIn)
        {
      ...
      public MWArray PF()
        {
          return mcr.EvaluateFunction("PF");
        }
      ...
      public MWArray[] PF(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "PF");
        }
      ...
      public MWArray pik()
        {
          return mcr.EvaluateFunction("pik");
        }
      ...
      ///
      public MWArray pik(MWArray max_iter, MWArray epsilon,
                         MWArray chain, MWArray goal, MWArray particles)
        {
          return mcr.EvaluateFunction("pik", max_iter, epsilon,
                                      chain, goal, particles);
        }
      ...
      ///
      public MWArray pik(MWArray max_iter, MWArray epsilon, MWArray chain,
                         MWArray goal, MWArray particles, MWArray S)
        {
          return mcr.EvaluateFunction("pik", max_iter, epsilon,
                                      chain, goal, particles, S);
        }
      ...
      public MWArray[] pik(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "pik");
        }
      ...
      ///
      public MWArray[] pik(int numArgsOut, MWArray max_iter,
                           MWArray epsilon, MWArray chain)
        {
          return mcr.EvaluateFunction(numArgsOut, "pik",
                                      max_iter, epsilon, chain);
        }
      ...
      ///
      public MWArray[] pik(int numArgsOut, MWArray max_iter,
                           MWArray epsilon, MWArray chain, MWArray goal)
        {
          return mcr.EvaluateFunction(numArgsOut, "pik", max_iter,
                                      epsilon, chain, goal);
        }
      ...
      public MWArray[] pik(int numArgsOut, MWArray max_iter,
        ...
        {
          return mcr.EvaluateFunction(numArgsOut, "pik", max_iter,
                                      epsilon, chain, goal, particles, S);
        }
      ...
      public MWArray point2quaternion()
        {
          return mcr.EvaluateFunction("point2quaternion");
        }
      ...
      public MWArray[] point2quaternion(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "point2quaternion");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void point2quaternion(int numArgsOut, ref MWArray[] argsOut,
                             MWArray[] argsIn)
        {
      ...
      public MWArray pointDistance()
        {
          return mcr.EvaluateFunction("pointDistance");
        }
      ...
      public MWArray[] pointDistance(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "pointDistance");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void pointDistance(int numArgsOut, ref MWArray[] argsOut,
                          MWArray[] argsIn)
        {
      ...
      public MWArray positions2chain()
        {
          return mcr.EvaluateFunction("positions2chain");
        }
      ...
      public MWArray[] positions2chain(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "positions2chain");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void positions2chain(int numArgsOut, ref MWArray[] argsOut,
                            MWArray[] argsIn)
        {
      ...
      public MWArray PrtFltr_MkwskSum()
        {
          return mcr.EvaluateFunction("PrtFltr_MkwskSum");
        }
      ...
      public MWArray PrtFltr_MkwskSum(MWArray max_iter, MWArray epsilon,
                                      MWArray S, MWArray x_axis, MWArray y_axis,
                                      MWArray obj, MWArray samples)
        {
          return mcr.EvaluateFunction("PrtFltr_MkwskSum", max_iter, epsilon,
                                      S, x_axis, y_axis, obj, samples);
        }
      ...
      public MWArray[] PrtFltr_MkwskSum(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "PrtFltr_MkwskSum");
        }
      ...
      public MWArray[] PrtFltr_MkwskSum(int numArgsOut, MWArray max_iter,
        ...
        {
          return mcr.EvaluateFunction(numArgsOut, "PrtFltr_MkwskSum",
                                      max_iter, epsilon, S, x_axis, y_axis);
        }
      ...
      public MWArray[] PrtFltr_MkwskSum(int numArgsOut, MWArray max_iter,
        ...
        {
          return mcr.EvaluateFunction(numArgsOut, "PrtFltr_MkwskSum", max_iter,
                                      epsilon, S, x_axis, y_axis, obj, samples);
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void PrtFltr_MkwskSum(int numArgsOut, ref MWArray[] argsOut,
                             MWArray[] argsIn)
        {
      ...
      public MWArray quaternion()
        {
          return mcr.EvaluateFunction("quaternion");
        }
      ...
      public MWArray[] quaternion(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternion");
        }
      ...
      public MWArray quaternion2point()
        {
          return mcr.EvaluateFunction("quaternion2point");
        }
      ...
      public MWArray[] quaternion2point(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternion2point");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternion2point(int numArgsOut, ref MWArray[] argsOut,
                             MWArray[] argsIn)
        {
      ...
      public MWArray quaternionConjugate()
        {
          return mcr.EvaluateFunction("quaternionConjugate");
        }
      ...
      public MWArray[] quaternionConjugate(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionConjugate");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionConjugate(int numArgsOut, ref MWArray[] argsOut,
                                MWArray[] argsIn)
        {
      ...
      public MWArray quaternionDistance()
        {
          return mcr.EvaluateFunction("quaternionDistance");
        }
      ...
      public MWArray[] quaternionDistance(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionDistance");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionDistance(int numArgsOut, ref MWArray[] argsOut,
                               MWArray[] argsIn)
        {
      ...
      public MWArray quaternionExponentialMap()
        {
          return mcr.EvaluateFunction("quaternionExponentialMap");
        }
      ...
      public MWArray[] quaternionExponentialMap(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionExponentialMap");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionExponentialMap(int numArgsOut, ref MWArray[] argsOut,
                                     MWArray[] argsIn)
        {
      ...
      public MWArray quaternionInnerProduct()
        {
          return mcr.EvaluateFunction("quaternionInnerProduct");
        }
      ...
      public MWArray[] quaternionInnerProduct(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionInnerProduct");
        }
      ...
      ///
      public MWArray[] quaternionInnerProduct(int numArgsOut,
                                              MWArray q1, MWArray q2)
        {
          return mcr.EvaluateFunction(numArgsOut,
                                      "quaternionInnerProduct", q1, q2);
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionInnerProduct(int numArgsOut, ref MWArray[] argsOut,
                                   MWArray[] argsIn)
        {
      ...
      public MWArray quaternionLogarithmicMap()
        {
          return mcr.EvaluateFunction("quaternionLogarithmicMap");
        }
      ...
      public MWArray[] quaternionLogarithmicMap(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionLogarithmicMap");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionLogarithmicMap(int numArgsOut, ref MWArray[] argsOut,
                                     MWArray[] argsIn)
        {
      ...
      public MWArray quaternionNorm()
        {
          return mcr.EvaluateFunction("quaternionNorm");
        }
      ...
      public MWArray[] quaternionNorm(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionNorm");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionNorm(int numArgsOut, ref MWArray[] argsOut,
                           MWArray[] argsIn)
        {
      ...
      public MWArray quaternionNormalize()
        {
          return mcr.EvaluateFunction("quaternionNormalize");
        }
      ...
      public MWArray[] quaternionNormalize(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionNormalize");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionNormalize(int numArgsOut, ref MWArray[] argsOut,
                                MWArray[] argsIn)
        {
      ...
      public MWArray quaternionProduct()
        {
          return mcr.EvaluateFunction("quaternionProduct");
        }
      ...
      public MWArray[] quaternionProduct(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionProduct");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionProduct(int numArgsOut, ref MWArray[] argsOut,
                              MWArray[] argsIn)
        {
      ...
      public MWArray quaternionQuTEMSampling()
        {
          return mcr.EvaluateFunction("quaternionQuTEMSampling");
        }
      ...
      public MWArray[] quaternionQuTEMSampling(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionQuTEMSampling");
        }
      ...
      ///
      public MWArray[] quaternionQuTEMSampling(int numArgsOut,
                                               MWArray m, MWArray pg)
        {
          return mcr.EvaluateFunction(numArgsOut,
                                      "quaternionQuTEMSampling", m, pg);
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionQuTEMSampling(int numArgsOut, ref MWArray[] argsOut,
                                    MWArray[] argsIn)
        {
      ...
      public MWArray quaternionRotation()
        {
          return mcr.EvaluateFunction("quaternionRotation");
        }
      ...
      public MWArray[] quaternionRotation(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionRotation");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void quaternionRotation(int numArgsOut, ref MWArray[] argsOut,
                               MWArray[] argsIn)
        {
      ...
      public MWArray quaternionUniformSampling()
        {
          return mcr.EvaluateFunction("quaternionUniformSampling");
        }
      ...
      public MWArray[] quaternionUniformSampling(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "quaternionUniformSampling");
        }
      ...
      public MWArray[] quaternionUniformSampling(int numArgsOut,
        ...
        {
          return mcr.EvaluateFunction(numArgsOut,
                                      "quaternionUniformSampling", samples);
        }
      ...
      public MWArray remostrejar()
        {
          return mcr.EvaluateFunction("remostrejar");
        }
      ...
      public MWArray[] remostrejar(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "remostrejar");
        }
      ...
      public MWArray rotation2quaternion()
        {
          return mcr.EvaluateFunction("rotation2quaternion");
        }
      ...
      public MWArray[] rotation2quaternion(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "rotation2quaternion");
        }
      ...
      ///
      public MWArray[] rotation2quaternion(int numArgsOut,
                                           MWArray theta, MWArray x)
        {
          return mcr.EvaluateFunction(numArgsOut,
                                      "rotation2quaternion", theta, x);
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void rotation2quaternion(int numArgsOut, ref MWArray[] argsOut,
                                MWArray[] argsIn)
        {
      ...
      public MWArray S_Touch()
        {
          return mcr.EvaluateFunction("S_Touch");
        }
      ...
      public MWArray[] S_Touch(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "S_Touch");
        }
      ...
      public MWArray setGaussianParameters()
        {
          return mcr.EvaluateFunction("setGaussianParameters");
        }
      ...
      public MWArray setGaussianParameters(MWArray media_gausiana,
        ...
        {
          return mcr.EvaluateFunction("setGaussianParameters", media_gausiana,
                                      rotar_en_x, rotar_en_y, rotar_en_z);
        }
      ...
      public MWArray[] setGaussianParameters(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "setGaussianParameters");
        }
      ...
      public MWArray[] setGaussianParameters(int numArgsOut,
        ...
        {
          return mcr.EvaluateFunction(numArgsOut, "setGaussianParameters",
                                      media_gausiana, rotar_en_x, rotar_en_y);
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void setGaussianParameters(int numArgsOut, ref MWArray[] argsOut,
                                  MWArray[] argsIn)
        {
      ...
      public MWArray slerp()
        {
          return mcr.EvaluateFunction("slerp");
        }
      ...
      public MWArray[] slerp(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "slerp");
        }
      ...
      ///
      public MWArray[] slerp(int numArgsOut, MWArray qOrigin,
                             MWArray qDestination)
        {
          return mcr.EvaluateFunction(numArgsOut, "slerp",
                                      qOrigin, qDestination);
        }
      ...
      ///
      public MWArray[] slerp(int numArgsOut, MWArray qOrigin,
                             MWArray qDestination, MWArray f)
        {
          return mcr.EvaluateFunction(numArgsOut, "slerp",
                                      qOrigin, qDestination, f);
        }
      ...
      ///
      public MWArray[] slerp(int numArgsOut, MWArray qOrigin,
                             MWArray qDestination, MWArray f, MWArray epsilon)
        {
          return mcr.EvaluateFunction(numArgsOut, "slerp", qOrigin,
                                      qDestination, f, epsilon);
        }
      ...
      public void testQuTEM()
        {
          mcr.EvaluateFunction(0, "testQuTEM");
        }
      ...
      ///
      public void testQuTEM(MWArray m, MWArray s, MWArray s1,
                            MWArray s2, MWArray s3, MWArray samples)
        {
      ...
      public MWArray[] testQuTEM(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "testQuTEM");
        }
      ...
      ///
      public MWArray[] testQuTEM(int numArgsOut, MWArray m,
                                 MWArray s, MWArray s1, MWArray s2)
        {
      ...
      public MWArray vectors2quaternion()
        {
          return mcr.EvaluateFunction("vectors2quaternion");
        }
      ...
      public MWArray[] vectors2quaternion(int numArgsOut)
        {
          return mcr.EvaluateFunction(numArgsOut, "vectors2quaternion");
        }
      ...
      /// <param name= "argsIn">Array of MWArray input arguments</param>
      ///
      public void vectors2quaternion(int numArgsOut, ref MWArray[] argsOut,
                               MWArray[] argsIn)
        {
