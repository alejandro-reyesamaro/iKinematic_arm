    ...
    internal class lbfgsb
    {
        ...
        *************************************************************************/
            ...
            out string msg)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                y[i+1] = initial_path[i].Point.Y; // la coordenada "Y" es la unica que varía
        ...
        private static string mensaje_exitoso(int iteration, int info, double longitud_camino)
        {
            /*Info    -   a return code:
                            ...
                            * 5 number of iterations exceeds MaxIts.
             * */
            string msg = "Operación concluida. ";
            switch (info)
            {
                case -2:
                    ...
                    break;
                case -1:
                    msg += "Ha ocurrido un error en la especificación de los parámetros.\n";
                    break;
                case 0:
                    msg += "Ha interrumpida por el usuario.\n";
                    break;
                case 1:
                    msg += "Se ha cumplido la condición de parada relativa al error absuluto de la función.\n";
                    break;
                case 2:
                    msg += "Se ha cumplido la condición de parada relativa al error absuluto en el punto.\n";
                    break;
                case 4:
                    msg += "Se ha cumplido la condición de parada relativa a la norma del gradiente.\n";
                    break;
                case 5:
                    msg += "Se ha llegado al máximo de iteraciones: " + iteration.ToString() + ".\n";
                    break;
                default:
                    msg += "No se conoce la naturaleza de la interrupción.\n";
                    break;
            }
            if (info != 5)
