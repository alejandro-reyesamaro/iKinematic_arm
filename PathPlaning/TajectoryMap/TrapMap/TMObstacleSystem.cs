...
namespace TrapezoidalMap
{
    public class TMObstacleSystem
    {
        ...
        {
            var l = new TMPoligonList(poligons);
            this.p_system = l;
        }
        ...
        public static List<TMTrapezoid> freeConfigurationSpacePrueba(TMPoligon universe, out TMNode sg)
        {
            ...
            var S_ = new List<TMSegment>
                         {
                             new TMSegment(new TMPoint(50, 50), new TMPoint(40, 60)),
                             new TMSegment(new TMPoint(60, 60), new TMPoint(50, 50)),
                             new TMSegment(new TMPoint(40, 60), new TMPoint(60, 60)),
                             new TMSegment(new TMPoint(30, 100), new TMPoint(70, 100)),
                             new TMSegment(new TMPoint(70, 100), new TMPoint(90, 80)),
                             new TMSegment(new TMPoint(90, 80), new TMPoint(10, 80)),
                             new TMSegment(new TMPoint(10, 80), new TMPoint(30, 100))
                         };
